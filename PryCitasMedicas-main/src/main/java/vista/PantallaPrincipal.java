...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    ListarCitas listarCitas = new ListarCitas(); // Crear instancia de ListarCitas
    Ingresar ingresarCitas = new Ingresar(listarCitas); // Pasar la instancia de ListarCitas a Ingresar

    contenedor_principal.add(ingresarCitas);
    ingresarCitas.setVisible(true);
    }//GEN-LAST:event_menu_ingreasar_citasActionPerformed

    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
    contenedor_principal.removeAll();
        contenedor_principal.add(new vista.citas.ListarCitas()).setVisible(true);
